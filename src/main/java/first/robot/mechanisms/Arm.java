 ...
 *
 * <p>Right now the arm can only do one thing: push a voltage at the motor. Both methods are private
 * and nothing calls them yet. Commands arrive in mech-2-Commands.
 */
